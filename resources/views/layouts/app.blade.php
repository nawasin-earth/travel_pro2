...
header section {
  padding: 0;
    ...
    .dropdown-item:hover {
    border: 1px solid #3D3D3D; /* เพิ่มเส้นกรอบเมื่อ hover */
    color: #2A2A2A; 
}
...
<body>
  <div id="app">
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
      <div class="container">
        <ul class="navbar-nav">
        <li id="ayana-lin"><a href="{{ url('/home') }}" class="nav-link">Tour Nua Isaan</a></li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('ranking') }}">ติดอันดับ</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('favorite') }}">รายการโปรด</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('news') }}">ข่าว</a>
          </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          @guest
          @if (Route::has('login'))
          <li class="nav-item">
