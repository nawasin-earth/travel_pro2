...
@else
    <a class="btn fill" href="{{ route('audience.vTravel') }}">เริ่มท่องเที่ยว</a>
@endif
    ...
    <section id="blog" class="grid">
      <div class="column-xs-12 text-center">
        ...
        <div class="column-xs-12 column-sm-4">
            <a href="{{ route('audience.vDetail', ['id' => $nongkhaiTravel->id]) }}">
                <figure>
        ...
        <div class="column-xs-12 column-sm-4">
            <a href="{{ route('audience.vDetail', ['id' => $udonThaniTravel->id]) }}">
                <figure>
        ...
        <div class="column-xs-12 column-sm-4">
            <a href="{{ route('audience.vDetail', ['id' => $buengKanTravel->id]) }}">
                <figure>
